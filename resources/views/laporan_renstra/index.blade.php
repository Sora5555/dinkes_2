    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Laporan Rencana Strategis</h4>
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            <tr style="background:#cccccc">
                                ...
                                <td align="center">Sasaran</td>
                                <td align="center">Indikator Kinerja Utama</td>
                                <td align="center">Data Capaian Awal</td>
                                <td align="center">Th ke 1</td>
                                <td align="center">Th ke 2</td>
                                <td align="center">Th ke 3</td>
                                <td align="center">Th ke 4</td>
                                <td align="center">Th ke 5</td>
                                <td align="center">Th ke 6</td>
                                <td align="center">Program</td>
                                <td align="center">Sasaran Program</td>
                                <td align="center">Indikator Sasaran Program</td>
                                <td align="center">Target Nilai</td>
                                <td align="center">Unit Organisasi</td>
                                <td align="center">Kegiatan</td>
                                <td align="center">Sasaran Kegiatan</td>
                                <td align="center">Indikator Sasaran Kegiatan</td>
                                <td align="center">Target Nilai</td>
                                <td align="center">Unit Organisasi</td>
                            </tr>
                            <tr>
                        ...
                        {{-- @if(count($visi) > 0)
                            ...
                            <thead class="text-center">
                                <tr style="background:#d6dad5">
                                   <th colspan>{{$v->tahun_awal}} - {{$v->tahun_akhir}}</th>
                                </tr>
