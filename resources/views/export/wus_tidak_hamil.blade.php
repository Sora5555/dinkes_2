<table id="data" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
    <thead class="text-center">
        <tr>
            <th>PERSENTASE CAKUPAN IMUNISASI Td PADA WANITA USIA SUBUR YANG TIDAK HAMIL MENURUT KECAMATAN DAN PUSKESMAS</th>
        </tr>
        <tr>
    ...
    @endphp
        ...
        <tr style='{{$key % 2 == 0?"background: #e9e9e9":""}}'>
            ...
            <td class="unit_kerja">{{$item->nama}}</td>
            <td>{{ $item->filterWus(Session::get('year'), 0)->jumlah }}</td>

            <td>{{ $item->filterWus(Session::get('year'), 0)->td1 }}</td>
            <td id="td1{{ $item->filterWus(Session::get('year'), 0)->id }}">
            ...
            <td>{{ $item->filterWus(Session::get('year'), 0)->td2 }}</td>
            <td id="td2{{ $item->filterWus(Session::get('year'), 0)->id }}">
            ...
            <td>{{ $item->filterWus(Session::get('year'), 0)->td3 }}</td>
            <td id="td3{{ $item->filterWus(Session::get('year'), 0)->id }}">
            ...
            <td>{{ $item->filterWus(Session::get('year'), 0)->td4 }}</td>
            <td id="td4{{ $item->filterWus(Session::get('year'), 0)->id }}">
            ...
            <td>{{ $item->filterWus(Session::get('year'), 0)->td5 }}</td>
            <td id="td5{{ $item->filterWus(Session::get('year'), 0)->id }}">
