                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">CAKUPAN VAKSINASI COVID-19 DOSIS 2</li>
                        </ol>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row justify-content-start mb-2">
                            <div class="col-md-10 d-flex justify-content-start gap-3">
                                <a type="button" class="btn btn-primary" href="{{ route('Table87.add', ['year' => Session::get('year')]) }}"><i class="mdi mdi-plus"></i>Add</a>
                            </div>
                            </div>
                            {{-- <div class="col-md-2">
                                ...
                                <tbody>
                                    ...
                                    @role('Admin|superadmin')
                                        ...
                                        <tr style='{{ $key % 2 == 0 ? 'background: #e9e9e9' : '' }}'>
                                            ...
                                            <td>
                                                @php
                                                    $sasaran_6_11 = $item->unitKerjaAmbilPart2('filterTable87', Session::get('year'), 'sasaran_6_11')['total'];
                                            ...
                                            <td>
                                                @php
                                                    $hasil_vaksinasi_6_11 = $item->unitKerjaAmbilPart2('filterTable87', Session::get('year'), 'hasil_vaksinasi_6_11')['total'];
                                            ...
                                            <td>
                                                @php
                                                    $sasaran_12_17 = $item->unitKerjaAmbilPart2('filterTable87', Session::get('year'), 'sasaran_12_17')['total'];
                                            ...
                                            <td>
                                                @php
                                                    $hasil_vaksinasi_12_17 = $item->unitKerjaAmbilPart2('filterTable87', Session::get('year'), 'hasil_vaksinasi_12_17')['total'];
                                            ...
                                            <td>
                                                @php
                                                    $sasaran_18_59 = $item->unitKerjaAmbilPart2('filterTable87', Session::get('year'), 'sasaran_18_59')['total'];
                                            ...
                                            <td>
                                                @php
                                                    $hasil_vaksinasi_18_59 = $item->unitKerjaAmbilPart2('filterTable87', Session::get('year'), 'hasil_vaksinasi_18_59')['total'];
                                            ...
                                            <td>
                                                @php
                                                    $sasaran_60_up = $item->unitKerjaAmbilPart2('filterTable87', Session::get('year'), 'sasaran_60_up')['total'];
                                            ...
                                            <td>
                                                @php
                                                    $hasil_vaksinasi_60_up = $item->unitKerjaAmbilPart2('filterTable87', Session::get('year'), 'hasil_vaksinasi_60_up')['total'];
                                    ...
                                    @role('Puskesmas|Pihak Wajib Pajak')
                                        @foreach ($desa as $key => $item)
                                            @if ($item->filterTable87(Session::get('year'), $item->id))
                                                <tr style='{{ $key % 2 == 0 ? 'background: #e9e9e9' : '' }}'>
                                                    <td>{{ $key + 1 }}</td>
                                                    ...
                                                    <td>
                                                        ...
                                                        id="{{ $item->filterTable87(Session::get('year'), $item->id)->id }}"
                                                        value="{{ $sasaran_6_11 }}"
                                                    ...
                                                    <td id="persen_6_11_{{ $item->filterTable87(Session::get('year'), $item->id)->id }}">
                                                        {{ $sasaran_6_11>0?number_format(($hasil_vaksinasi_6_11 / $sasaran_6_11) * 100, 2) . '%':0 }}
                                                    </td>
                                                    <td>
                                                        @php
                                                    ...
                                                    <td id="persen_12_17_{{ $item->filterTable87(Session::get('year'), $item->id)->id }}">
                                                        {{ $sasaran_12_17>0?number_format(($hasil_vaksinasi_12_17 / $sasaran_12_17) * 100, 2) . '%':0 }}
                                                    </td>
                                                    <td>
                                                        @php
                                                    ...
                                                    <td id="persen_18_59_{{ $item->filterTable87(Session::get('year'), $item->id)->id }}">
                                                        {{ $sasaran_18_59>0?number_format(($hasil_vaksinasi_18_59 / $sasaran_18_59) * 100, 2) . '%':0 }}
                                                    </td>
                                                    <td>
                                                        @php
                                                    ...
                                                    <td id="persen_60_up_{{ $item->filterTable87(Session::get('year'), $item->id)->id }}">
                                                        {{ $sasaran_60_up>0?number_format(($hasil_vaksinasi_60_up / $sasaran_60_up) * 100, 2) . '%':0 }}
                                                    </td>

                                                    <td id="total_sasaran_{{ $item->filterTable87(Session::get('year'), $item->id)->id }}">
                                                        @php
                                                            $total_sasaran_ = $sasaran_6_11 + $sasaran_12_17 + $sasaran_18_59 + $sasaran_60_up;
                                                            echo $total_sasaran_;
                                                            $Grandtotal_sasaran += $total_sasaran_;
                                                    ...
                                                    <td id="total_hasil_vaksinasi_{{ $item->filterTable87(Session::get('year'), $item->id)->id }}">
                                                        @php
                                                            $total_hasil_vaksinasi_ = $hasil_vaksinasi_6_11 + $hasil_vaksinasi_12_17 + $hasil_vaksinasi_18_59 + $hasil_vaksinasi_60_up;
                                                            echo $total_hasil_vaksinasi_;
                                                            $Grandtotal_hasil_vaksinasi += $total_hasil_vaksinasi_;
                                                    ...
                                                    <td id="total_persen_{{ $item->filterTable87(Session::get('year'), $item->id)->id }}">
                                                        {{ $total_sasaran_>0?number_format(($total_hasil_vaksinasi_ / $total_sasaran_) * 100, 2) . '%':0 }}
                                                    </td>
