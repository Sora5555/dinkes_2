                    ...
                    <div class="card-body">
                        <div class="row justify-content-start mb-2">
                            <div class="col-md-10 d-flex justify-content-start gap-3">
                                <a type="button" class="btn btn-primary" href="{{ route('Table85.add', ['year' => Session::get('year')]) }}"><i class="mdi mdi-plus"></i>Add</a>
                            </div>
                            </div>
                            {{-- <div class="col-md-2">
                                                ...
                                                <tr style='{{ $key % 2 == 0 ? 'background: #e9e9e9' : '' }}'>
                                                    ...
                                                    <td>
                                                        @php
                                                            ...
                                                            $Grand_l_0_4 += $l_0_4;
                                                        @endphp
                                                        <input type="number" name="l_0_4"
                                                        id="{{ $item->filterTable85(Session::get('year'), $item->id)->id }}"
                                                        value="{{ $l_0_4 }}"
                                                    ...
                                                    <td>
                                                        @php
                                                            ...
                                                            $Grand_l_15_59 += $l_15_59;
                                                        @endphp
                                                        <input type="number" name="l_15_59"
                                                        id="{{ $item->filterTable85(Session::get('year'), $item->id)->id }}"
                                                        value="{{ $l_15_59 }}"
                                                        class="form-control data-input" style="border: none">
                                                    </td>
                                                    <td>
                                                        @php
                                                            ...
                                                            $Grand_p_15_59 += $p_15_59;
                                                        @endphp
                                                        <input type="number" name="p_15_59"
                                                        id="{{ $item->filterTable85(Session::get('year'), $item->id)->id }}"
                                                        value="{{ $p_15_59 }}"
                                                        class="form-control data-input" style="border: none">
                                                    </td>
                                                    <td>
                                                        @php
                                                            ...
                                                            $Grand_l_60_up += $l_60_up;
                                                        @endphp
                                                        <input type="number" name="l_60_up"
                                                        id="{{ $item->filterTable85(Session::get('year'), $item->id)->id }}"
                                                        value="{{ $l_60_up }}"
                                                        class="form-control data-input" style="border: none">
                                                    </td>
                                                    <td>
                                                        @php
                                                            ...
                                                            $Grand_p_60_up += $p_60_up;
                                                        @endphp
                                                        <input type="number" name="p_60_up"
                                                        id="{{ $item->filterTable85(Session::get('year'), $item->id)->id }}"
                                                        value="{{ $p_60_up }}"
                                                        class="form-control data-input" style="border: none">
                                                    </td>
