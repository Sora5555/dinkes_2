            ...
            if(res.status == "success"){
                    ...
                    misi.forEach(element => {
                        ...
                        tujuan.forEach(elementTr => {
                            ...
                            if(elementSr.tujuan_renstra_id == elementTr.id){
                                td += `
                            <tr>
                            <td colspan="11"><span style="padding-left: 28px">${elementSr.nama}</span></td>
                            ...
                            <td colspan="4">Capaian triwulan</td>
                ...
                if(elementIo.sasaran_renstra_id == elementSr.id){
                    ...
                    <tr>
                            ...
                            <td>${elementIo.capaian_satu}</td>
                            <td>${elementIo.capaian_dua}</td>
                            <td>${elementIo.capaian_tiga}</td>
                            <td>${elementIo.capaian_empat}</td>
            ...
            sasaranRenstra.forEach(element => {
                ...
                if(elementIku.id == element.indikator_pemerintah_id){
                   ...
                   <tr>
                            ...
                            <td>${elementIku.capaian_satu}</td>
                            <td>${elementIku.capaian_dua}</td>
                            <td>${elementIku.capaian_tiga}</td>
                            <td>${elementIku.capaian_empat}</td>
