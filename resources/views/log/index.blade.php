                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-2">
                            ...
                            <input type="datetime-local" name="date1" class="form-control" value='{{ date('Y-m-d h:m:s') }}' id='date1'>
                        </div>

                        <div class="col-md-2">
                            <label for="date2">Akhir</label>
                            <input type="datetime-local" name="date2" class="form-control" value='{{ date('Y-m-d h:m:s') }}' id='date2'>
                        </div>
                    </div>
