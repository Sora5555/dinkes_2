    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Laporan Monev Anggaran</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Laporan</a></li>
                        <li class="breadcrumb-item active">Monev Anggaran</li>
                    </ol>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            <tr style="background:#cccccc">
                                ...
                                <td align="center" rowspan="2">Program/kegiatan</td>
                                <td align="center" rowspan="2">Pagu Anggaran</td>
                                <td align="center" colspan="5">Realisasi Anggaran</td>
                            </tr>
                            <tr>
                                <td style="white-space: nowrap" align="center">TW I</td>
                                <td style="white-space: nowrap" align="center">TW II</td>
                                <td align="center">TW III</td>
                                <td align="center">TW IV</td>
