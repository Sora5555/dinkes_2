    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Laporan IKU</h4>
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            <tr style="background:#cccccc">
                                ...
                                <td colspan="2" align="center">Kinerja Utama</td>
                                <td align="center" rowspan="2">Indikator Kinerja Utama</td>
                                <td align="center" rowspan="2">Parameter Pengukuran</td>
                                <td align="center" rowspan="2">Penjelasan</td>
                            </tr>
                            <tr>
