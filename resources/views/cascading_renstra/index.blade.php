    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Cascading Renstra</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Pemetaan</a></li>
                        <li class="breadcrumb-item active">Cascading Renstra</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row justify-content-start mb-2">
                        <div class="col-md-5 mb-5 d-flex justify-content-start align-items-center">
                    ...
                    <div class="row justify-content-center mb-2">
                        <div class="col-md-11 d-flex justify-content-start align-items-center" style="background: #c4f5cd;">
                            <h5>Merujuk</h5>
                        </div>
                    </div>
                    ...
                    <thead>
                        <tr style="background:#f5f2c4">
                            <th style="padding-left: 7px"><div class="d-flex justify-content-between align-items-center">Visi RPJMD: Visi</div></th>
                        </tr>
                        {{-- <tr style="background:#dcf5c4">
                            <th style="padding-left: 14px"><div class="d-flex justify-content-between align-items-center">Misi RPJMD: Misi</div></th>
                        </tr>
                        <tr style="background:#c4f5e2">
                            <th style="padding-left: 21px"><div class="d-flex justify-content-between align-items-center">Tujuan RPJMD: Tujuan</div></th>
                        </tr>
                        <tr style="background:#ffffff">
                            <th style="padding-left: 28px"><div class="d-flex justify-content-between align-items-center">Sasaran RPJMD: Sasaran</div></th>
                        </tr> --}}
                    </thead>
                    {{-- @if(count($visi) > 0)
                        @foreach ($visi as $v)
