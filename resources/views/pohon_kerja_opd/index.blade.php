    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Pohon Kinerja OPD</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Pemetaan</a></li>
                        <li class="breadcrumb-item active">Pohon Kinerja OPD</li>
                    </ol>
                </div>
                ...
                <div class="card-body">
                    ...
                    <thead>
                        <tr style="background:#f5f2c4">
                            <th style="padding-left: 7px"><div class="d-flex justify-content-between align-items-center">Belum ada Data</div></th>
                        </tr>
                    </thead>
                    {{-- @if(count($visi) > 0)
                        @foreach ($visi as $v)
