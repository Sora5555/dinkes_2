    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Import data</h4>
                ...
                <div class="card-body">
                    <div class="row justify-content-end mb-2">
                        <div class="col-md-12 d-flex justify-content-start">
                            ...
                            <form class="col-md-12 d-flex justify-content-around gap-3" action="{{ route('import') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <select name="tahun" id="tahun" class="form-control">
                                    <option value="2023">2023</option>
                                </select>
                                <select name="data" id="tahun" class="form-control">
                                    <option value="IbuHamilDanBersalin">Ibu Hamil Dan Bersalin</option>
                                    <option value="KesehatanBalita">Kesehatan Balita</option>
                                    <option value="Odgj">Orang dalam gangguan jiwa</option>
                                    <option value="Diabetes">Diabetes Melitus</option>
                                    <option value="PelayananProduktif">Pelayanan Produktif</option>
                                    <option value="PelayananLansia">Pelayanan Lansia</option>
                                </select>
                                <input type="file" name="excel_file" class="form-control">
                                <button type="submit" class="btn btn-primary">Import</button>
                                <a class="btn btn-success" href="/storage/image/template.xlsx" download="">Template</a>
                            </form>
                        </div>
                        {{-- <div class="col-md-2">
