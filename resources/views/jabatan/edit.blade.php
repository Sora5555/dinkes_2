        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::model($npa,['route'=>[$route.'.update',$npa->id],'name'=>'myForm','method'=>'PUT','onsubmit'=>'','id'=>'myForm','files'=>true]) !!}
                        @csrf
                    <div class="row">
                        <div class="col-10">
                            <div class="row">
                            ...
                            <div class="mb-3 row">
                                <label for="example-text-input" class="col-md-2 col-form-label">Wilayah</label>
                                <div class="col-md-10">
                                    {!! Form::select('wilayah_id[]',$wilayah,isset($npa)?$npa->wilayah->pluck('id'):null,['class'=>'select2 form-control wilayah','id'=>'wilayah','multiple'=>'multiple']) !!}
                                </div>
                            </div>
                            <div class="inputs">
                                <div class="row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-3">
                                        <input class="form-control meter_sebelumnya" type="number" name="volume_awal" id="meter_sebelumnya" min="0" value="{{$npa->volume_awal?$npa->volume_awal:0}}" onkeyup="getPemakaian(this)" data-queu="0">
                                    </div>
                                    <div class="col-md-3">
                                        <input class="form-control meter_sekarang" type="number" name="volume_akhir" id="meter_sekarang" min="0" value="{{$npa->volume_akhir}}" onkeyup="getPemakaian(this)" data-queu="0">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3 row">
