                    ...
                    <div class="table-responsive">
                        ...
                        <div class="row justify-content-start mb-2">
                            <div class="col-md-10 d-flex justify-content-around gap-3">
                                @if(Auth::user()->downloadFile('JaminanKesehatan', Session::get('year')))
                                <form action="/upload/general" method="post" class="d-flex gap-5" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="name" value="JaminanKesehatan" id="">
                                    <input type="file" name="file_upload" id="" {{Auth::user()->downloadFile('JaminanKesehatan', Session::get('year'))->status == 1 ?"disabled":""}} class="form-control" placeholder="upload PDF file">
                                    <button type="submit" class="btn btn-success" {{Auth::user()->downloadFile('JaminanKesehatan', Session::get('year'))->status == 1?"disabled":""}}>Upload</button>
