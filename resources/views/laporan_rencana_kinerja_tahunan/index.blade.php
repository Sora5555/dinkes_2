    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Laporan Rencana Kinerja Tahunan</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Laporan</a></li>
                        <li class="breadcrumb-item active">Rencana Kinerja Tahunan</li>
                    </ol>
                </div>
                    ...
                    <div class="table-responsive">
                        ...
                        <tbody>
                            <tr style="background:#cccccc">
                                ...
                                <td align="center">Parameter Pengukuran</td>
                                <td align="center">Target</td>
                            </tr>
                            <tr>
                                <td style="white-space: nowrap" align="center">1</td>
                                <td style="white-space: nowrap" align="center">2</td>
