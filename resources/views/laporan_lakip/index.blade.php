    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Laporan Pengukuran Kinerja</h4>
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-end mb-2">
                        <div class="col-md-12 d-flex justify-content-around">
                            ...
                            <button class="btn btn-sm" style="background:#42d0f7;margin-left:12px">Cetak Word</button>
                        </div>
                    </div>
                    <div class="table-responsive">
                        ...
                        <tbody>
                            <tr>
                                <td colspan="7" align="center">Cetak Laporan Lakip</td>
                            </tr>
                        </tbody>
                        </table>
                    </div>
