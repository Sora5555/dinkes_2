...
class Table71Export implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.table_71')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:AG1'); // Shifted from 'A1:AG1' to 'A3:AG3' (two extra rows)
            $sheet->mergeCells('A2:AG2'); // Shifted from 'A1:AG1' to 'A3:AG3' (two extra rows)
            $sheet->mergeCells('A3:AG3'); // Shifted from 'A1:AG1' to 'A3:AG3' (two extra rows)

            // Merge main header sections
        

            // Apply styles
            $sheet->getStyle('A1:AG5')->applyFromArray([
                'font' => ['bold' => true],
                'alignment' => [
            ...
            // $sheet->getStyle("A" . ($lastRow - 2) . ":AG" . ($lastRow - 2))->applyFromArray([
            //     'borders' => [
            //         'top' => [
            //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
            //             'color' => ['argb' => '000000'], // Black color
            ...
            //     ],
            // ]);
            // $sheet->getStyle("A" . ($lastRow - 1) . ":AG" . ($lastRow - 1))->applyFromArray([
            //     'borders' => [
            //         'top' => [
            //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
            //             'color' => ['argb' => '000000'], // Black color
            ...
            $sheet->getStyle('A5:AG5')->applyFromArray([
               'borders' => [
                    'bottom' => [
                        'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        'color' => ['argb' => '000000'], // Black color
            ...
            $sheet->getStyle('A4:AG5')->applyFromArray([
               'borders' => [
                    'bottom' => [
                        'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        'color' => ['argb' => '000000'], // Black color
            ...
            // $sheet->getStyle('A7:AG7')->applyFromArray([
            //    'borders' => [
            //         'bottom' => [
            //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
            //             'color' => ['argb' => '000000'], // Black color
