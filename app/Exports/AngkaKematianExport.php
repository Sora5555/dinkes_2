...
class AngkaKematianExport implements FromCollection, WithHeadings, WithEvents, WithCustomStartCell
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        $no = 0;
        $mappedData = $AngkaKematian->map(function ($item, $no) {
            // Data unit kerja sebagai header
            return [
                'th1' => $no++,
                'th2' => $item->nama_rumah_sakit,
                'th3' => $item->jumlah_tempat_tidur,
                'th4' => $item->pasien_keluar_hidup_mati_L,
                'th5' => $item->pasien_keluar_hidup_mati_P,
                'th6' => $item->pasien_keluar_hidup_mati_P + $item->pasien_keluar_hidup_mati_L,
                'th7' => $item->pasien_keluar_mati_L,
                'th8' => $item->pasien_keluar_mati_P,
                'th9' => $item->pasien_keluar_mati_L + $item->pasien_keluar__mati_P,
                'th10' => $item->pasien_keluar_mati_48_L,
                'th11' => $item->pasien_keluar_mati_48_P,
                'th12' => $item->pasien_keluar_mati_L + $item->pasien_keluar__mati_P,
                'th13' => $item->pasien_keluar_hidup_mati_L>0?number_format($item->pasien_keluar_mati_L/$item->pasien_keluar_hidup_mati_L * 100, 2):0,
                'th14' => $item->pasien_keluar_hidup_mati_P>0?number_format($item->pasien_keluar_mati_P/$item->pasien_keluar_hidup_mati_P * 100, 2):0,
                'th15' => $item->pasien_keluar_hidup_mati_P+$item->pasien_keluar_hidup_mati_L>0?number_format(($item->pasien_keluar_mati_P+$item->pasien_keluar_mati_L)/($item->pasien_keluar_hidup_mati_L + $item->pasien_keluar_hidup_mati_P) * 100, 2):0,
                'th16' => $item->pasien_keluar_mati_48_L>0?number_format($item->pasien_keluar_mati_L/$item->pasien_keluar_mati_48_L * 100, 2):0,
                'th17' => $item->pasien_keluar_mati_48_P>0?number_format($item->pasien_keluar_mati_P/$item->pasien_keluar_mati_48_P * 100, 2):0,
                'th18' => $item->pasien_keluar_mati_48_P+$item->pasien_keluar_mati_48_L>0?number_format(($item->pasien_keluar_mati_P+$item->pasien_keluar_mati_L)/($item->pasien_keluar_mati_48_L + $item->pasien_keluar_mati_48_P) * 100, 2):0,
    ...
    public function headings(): array
    {
        return [
            ...
            ['No', 'Nama Rumah Sakit', 'Jumlah Tempat Tidur', 'PASIEN KELUAR (HIDUP + MATI)', '', '', 'PASIEN KELUAR MATI', '', '', 'PASIEN KELUAR MATI >= 48 jam dirawat', '', '', 'GROSS DEATH RATE', '', '', 'GROSS DEATH RATE', '', ''],
