...
class OdhivExport implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.odhiv')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:E1'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A2:E2'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A3:E3'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
