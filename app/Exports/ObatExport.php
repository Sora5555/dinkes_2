...
class ObatExport implements FromCollection, WithHeadings, WithEvents, WithCustomStartCell
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        // });
        // $no = 0;
        $mappedData = $obat->map(function($item, $no) {
        ...
        $mappedData[] = [
            'jumlah_vaksin' => 'JUMLAH ITEM OBAT INDIKATOR YANG TERSEDIA DI KABUPATEN/KOTA',
            'empty_1' => '',
            'empty_2' => '',
