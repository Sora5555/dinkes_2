...
class Table70Export implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.table_70')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:E1'); // Shifted from 'A1:E1' to 'A3:E3' (two extra rows)
            $sheet->mergeCells('A2:E2'); // Shifted from 'A1:E1' to 'A3:E3' (two extra rows)
            $sheet->mergeCells('A3:E3'); // Shifted from 'A1:E1' to 'A3:E3' (two extra rows)
            ...
            // $sheet->getStyle("A" . ($lastRow - 2) . ":E" . ($lastRow - 2))->applyFromArray([
            //     'borders' => [
            //         'top' => [
            //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
            //             'color' => ['argb' => '000000'], // Black color
