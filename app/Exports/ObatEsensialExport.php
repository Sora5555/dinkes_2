...
class ObatEsensialExport implements FromCollection, WithHeadings, WithEvents, WithCustomStartCell
{
    /**
    ...
    */
    ...
    public function collection()
    {
        ...
        // });
        // $no = 0;
        $mappedData = $unit_kerja->map(function($unit, $no) {
            $KetersediaanObatEsensial = "-";

            if($unit->ObatEsensial) {
                if($unit->ObatEsensial->status == 1) {
                    $KetersediaanObatEsensial = '> 80%';
                } else if($unit->ObatEsensial->status == 2) {
                    $KetersediaanObatEsensial = '< 80%';
                }
            }
        ...
        $mappedData[] = [
            'jumlah_vaksin' => 'JUMLAH PUSKESMAS YANG MEMILIKI 80% OBAT DAN VAKSIN ESENSIAL',
            'empty_1' => '',
            'empty_2' => '',
        ...
        $mappedData[] = [
            'jumlah_puskesmas_yang_melapor' => 'JUMLAH PUSKESMAS YANG MELAPOR',
            'empty_1' => '',
            'empty_2' => '',
        ...
        $mappedData[] = [
            'kabupaten_kota_dengan_ketersedian_obat_esensial' => 'KABUPATEN/KOTA DENGAN KETERSEDIAAN OBAT ESENSIAL',
            'empty_1' => '',
            'empty_2' => '',
            'total_obat' => ($total_obat?number_format($obat_tersedia/$total_obat * 100, 2):0),
        ];
    ...
    public function headings(): array
    {
        return [
            ...
            ['No', 'Unit Kerja', 'Ketersediaan obat esensial',''],
