...
class Table65Export implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.table_65')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:J1'); // Shifted from 'A1:J1' to 'A3:J3' (two extra rows)
            $sheet->mergeCells('A2:J2'); // Shifted from 'A1:J1' to 'A3:J3' (two extra rows)
            $sheet->mergeCells('A3:J3'); // Shifted from 'A1:J1' to 'A3:J3' (two extra rows)
            ...
            // $sheet->getStyle("A" . ($lastRow - 2) . ":J" . ($lastRow - 2))->applyFromArray([
            //     'borders' => [
            //         'top' => [
            //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
            //             'color' => ['argb' => '000000'], // Black color
