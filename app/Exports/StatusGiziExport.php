...
class StatusGiziExport implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.status_gizi')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:M1'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A2:M2'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A3:M3'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
