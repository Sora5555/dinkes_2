...
class Table68Export implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.table_68')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:D1'); // Shifted from 'A1:D1' to 'A3:D3' (two extra rows)
            $sheet->mergeCells('A2:D2'); // Shifted from 'A1:D1' to 'A3:D3' (two extra rows)
            $sheet->mergeCells('A3:D3'); // Shifted from 'A1:D1' to 'A3:D3' (two extra rows)
            ...
            // $sheet->getStyle("A" . ($lastRow - 2) . ":D" . ($lastRow - 2))->applyFromArray([
            //     'borders' => [
            //         'top' => [
            //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
            //             'color' => ['argb' => '000000'], // Black color
