...
class BadutaImunisasiExport implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.baduta_imunisasi')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:Q1'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A2:Q2'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A3:Q3'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
