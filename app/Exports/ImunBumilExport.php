...
class ImunBumilExport implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.imun_bumil')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:O1'); // Shifted from 'A1:W1' to 'A3:W3' (two extra rows)
            $sheet->mergeCells('A2:O2'); // Shifted from 'A1:W1' to 'A3:W3' (two extra rows)
            $sheet->mergeCells('A3:O3'); // Shifted from 'A1:W1' to 'A3:W3' (two extra rows)
