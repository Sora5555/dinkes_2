...
class GigiAnakExport implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.gigi_anak')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:Y1'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A2:Y2'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A3:Y3'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)

            // Merge main header sections
        

            // Apply styles
            $sheet->getStyle('A1:Y6')->applyFromArray([
                'font' => ['bold' => true],
                'alignment' => [
            ...
            $sheet->getStyle('A4:Y6')->applyFromArray([
               'borders' => [
                    'bottom' => [
                        'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        'color' => ['argb' => '000000'], // Black color
            ...
            $sheet->getStyle('A5:Y6')->applyFromArray([
               'borders' => [
                    'bottom' => [
                        'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        'color' => ['argb' => '000000'], // Black color
