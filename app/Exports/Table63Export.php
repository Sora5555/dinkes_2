...
class Table63Export implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.table_63')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:I1'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A2:I2'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A3:I3'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
