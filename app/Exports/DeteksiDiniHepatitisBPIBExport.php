...
class DeteksiDiniHepatitisBPIBExport implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.deteksi_dini_hepatitis_bpib')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:H1'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A2:H2'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
            $sheet->mergeCells('A3:H3'); // Shifted from 'A1:K1' to 'A3:K3' (two extra rows)
