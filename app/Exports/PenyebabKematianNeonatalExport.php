...
class PenyebabKematianNeonatalExport implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.penyebab_kematian_neonatal')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:S1'); // Shifted from 'A1:W1' to 'A3:W3' (two extra rows)
            $sheet->mergeCells('A2:S2'); // Shifted from 'A1:W1' to 'A3:W3' (two extra rows)
            $sheet->mergeCells('A3:S3'); // Shifted from 'A1:W1' to 'A3:W3' (two extra rows)
