...
class Table67Export implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.table_67')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:H1'); // Shifted from 'A1:H1' to 'A3:H3' (two extra rows)
            $sheet->mergeCells('A2:H2'); // Shifted from 'A1:H1' to 'A3:H3' (two extra rows)
            $sheet->mergeCells('A3:H3'); // Shifted from 'A1:H1' to 'A3:H3' (two extra rows)
            ...
            // $sheet->getStyle("A" . ($lastRow - 2) . ":H" . ($lastRow - 2))->applyFromArray([
            //     'borders' => [
            //         'top' => [
            //             'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
            //             'color' => ['argb' => '000000'], // Black color
