...
class BayiImunisasiExport implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.bayi_imunisasi')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            // Apply styles
            $sheet->getStyle('A1:AC7')->applyFromArray([
                'font' => ['bold' => true],
                'alignment' => [
            ...
            $sheet->getStyle('A4:AC7')->applyFromArray([
               'borders' => [
                    'bottom' => [
                        'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        'color' => ['argb' => '000000'], // Black color
            ...
            $sheet->getStyle('A5:AC7')->applyFromArray([
               'borders' => [
                    'bottom' => [
                        'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        'color' => ['argb' => '000000'], // Black color
