...
class KematianNeonatalExport implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.kematian_neonatal')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:Q1'); // Shifted from 'A1:W1' to 'A3:W3' (two extra rows)
            $sheet->mergeCells('A2:Q2'); // Shifted from 'A1:W1' to 'A3:W3' (two extra rows)
            $sheet->mergeCells('A3:Q3'); // Shifted from 'A1:W1' to 'A3:W3' (two extra rows)
            ...
            $sheet->getStyle('A5:Q7')->applyFromArray([
               'borders' => [
                    'bottom' => [
                        'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        'color' => ['argb' => '000000'], // Black color
