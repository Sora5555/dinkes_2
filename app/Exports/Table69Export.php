...
class Table69Export implements FromView, WithEvents
{
    public function view(): View
    {
        ...
        return view('export.table_69')->with($data);
    }
    ...
    public function registerEvents(): array
{
    return [
        AfterSheet::class => function(AfterSheet $event) {
            ...
            $sheet->mergeCells('A1:S1'); // Shifted from 'A1:S1' to 'A3:S3' (two extra rows)
            $sheet->mergeCells('A2:S2'); // Shifted from 'A1:S1' to 'A3:S3' (two extra rows)
            $sheet->mergeCells('A3:S3'); // Shifted from 'A1:S1' to 'A3:S3' (two extra rows)

            // Merge main header sections
        

            // Apply styles
            $sheet->getStyle('A1:S7')->applyFromArray([
                'font' => ['bold' => true],
                'alignment' => [
            ...
            $sheet->getStyle("A" . ($lastRow - 2) . ":S" . ($lastRow - 2))->applyFromArray([
                'borders' => [
                    'top' => [
                        'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        'color' => ['argb' => '000000'], // Black color
            ...
            $sheet->getStyle("A" . ($lastRow - 1) . ":S" . ($lastRow - 1))->applyFromArray([
                'borders' => [
                    'top' => [
                        'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        'color' => ['argb' => '000000'], // Black color
            ...
            $sheet->getStyle('A4:S6')->applyFromArray([
               'borders' => [
                    'bottom' => [
                        'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                        'color' => ['argb' => '000000'], // Black color
